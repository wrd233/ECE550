...
updateregs()                       addi $22 $0 0
                                   addi $24 $0 15
                                   # 40($22)也就是40(0)存储着$1的信息，它就是row1,row2
                                   lw $1 40($22)	
                                   addi $22 $22 1
                                   lw $23 40($22)
                                   sll $23 $23 $24
...
```assembly
renewInfo()                        addi $22 $0 97		
                                   beq $22 $21 left #下面开始判断按键
                                   addi $22 $0 100
                                   beq $22 $21 right
                                   addi $22 $0 119
                                   beq $22 $21 rotate
                                   j endrenewInfo
left                               add $0 $0 $0			# 这里开始尝试向左移动
                                   addi $23 $0 -1		
                                   addi $25 $0 15	#$25存储了行位置的右边界(15)
                                   addi $24 $0 0	#?
canmove0loop                       bgt $24 $25 canmove0endloop	#如果已经超出了右边界则左移失效
                                   srl $26 $18 $24		#$18存的什么？ #$26存的什么？
                                   									#将$18右移 $24 个bit，然后存到$26
                                   #判断$26的最低位是否为1
                                   addi $1 $0 1
                                   and $26 $26 $1
                                   beq $26 $0 canmove0continue	#如果$26的最低位为0，那么还能继续移动
                                   #此时$26的最低位为1，无法继续移动
                                   addi $1 $0 2
                                   srl $3 $24 $1
                                   addi $1 $0 3
